            ...
            <div class="card">
                <div class="card-body">
                    <table cellspacing="1" cellpadding="2" border="0" width="100%" class="tab">
                        ...
                        <tr>
                            <td colspan="3" align="right"><a href="javascript:openCalculator('4')">Calculate your profit
                                    &gt;&gt;</a></td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="card">
                <div class="card-body">
                    <table cellspacing="1" cellpadding="2" border="0" width="100%" class="tab">
                        ...
                        <tr>
                            <td colspan="3" align="right"><a href="javascript:openCalculator('5')">Calculate your profit
                                    &gt;&gt;</a></td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="card">
                <div class="card-body">
                    <table cellspacing="1" cellpadding="2" border="0" width="100%" class="tab">
                        ...
                        <tr>
                            <td colspan="3" align="right"><a href="javascript:openCalculator('6')">Calculate your profit
                                    &gt;&gt;</a></td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="card">
                <div class="card-body">
                    <table cellspacing="1" cellpadding="2" border="0" width="100%" class="tab">
                        ...
                        <tr>
                            <td colspan="3" align="right"><a href="javascript:openCalculator('7')">Calculate your profit
                                    &gt;&gt;</a></td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="card">
                <div class="card-body">
                    <table cellspacing="1" cellpadding="2" border="0" width="100%" class="tab">
                        ...
                        <tr>
                            <td colspan="3" align="right"><a href="javascript:openCalculator('8')">Calculate your profit
                                    &gt;&gt;</a></td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="card">
                <div class="card-body">
                    <table cellspacing="1" cellpadding="2" border="0" width="100%" class="tab">
                        ...
                        <tr>
                            <td colspan="3" align="right"><a href="javascript:openCalculator('9')">Calculate your profit
                                    &gt;&gt;</a></td>
                        </tr>
                        </tbody>
                    </table>
